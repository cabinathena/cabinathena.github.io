const books = [
    ...
    ,
    {
        ...
        preview: "Karena kau bisa memahami bahwa pelangi tampak indah karena berwarna-warni.",
        ...
        cover: {
            small: "../../assets/Si Anak Pelangi.jpg",
            large: "../../assets/Si Anak Pelangi.jpg"
        },
        contents: [
            {
                title: "Review",
    ...
    ,
    {
        ...
        color: "#edb328",
        categories: [
            "fiction", "indonesia", "adventure"
        ],
        preview: "Ada jodoh yang ditemukan lewat tatapan pertama. Ada persahabatan yang diawali lewat sapa hangat.",
        synopsis: "Ada jodoh yang ditemukan lewat tatapan pertama. Ada persahabatan yang diawali lewat sapa hangat. Bagaimana jika takdir bersama ternyata, diawali dengan pertarungan mematikan? Lantas semua cerita berkelindan dengan, pengejaran demi pengejaran mencari jawaban? Pulang-Pergi.",
        cover: {
            small: "../../assets/Pulang Pergi.jpg",
            large: "../../assets/Pulang Pergi.jpg"
        },
        contents: [
            {
                title: "Review",
    ...
    ,
    {
        ...
        color: "#444342",
        categories: [
            "fiction", "indonesia", "adventure", "fantasy", "young adult"
        ],
        preview: "SELENA dan NEBULA adalah buku ke-8 dan ke-9 yang menceritakan siapa orangtua Raib dalam serial petualangan dunia paralel.",
        ...
        cover: {
            small: "../../assets/Nebula.jpg",
            large: "../../assets/Nebula.jpg"
        },
        contents: [
            {
                title: "Review",
    ...
    ,
    {
        ...
        synopsis: "SELENA dan NEBULA adalah buku ke-8 dan ke-9 yang menceritakan siapa orangtua Raib dalam serial petualangan dunia paralel. Dua buku ini sebaiknya dibaca berurutan. Kedua buku ini juga bercerita tentang Akademi Bayangan Tingkat Tinggi, sekolah terbaik di seluruh Klan Bulan. Tentang persahabatan tiga mahasiswa, yang diam-diam memiliki rencana bertualang ke tempat-tempat jauh. Tapi petualangan itu berakhir buruk, saat persahabatan mereka diuji dengan rasa suka, egoisme, dan pengkhianatan. Ada banyak karakter baru, tempat-tempat baru, juga sejarah dunia paralel yang diungkap. Di dua buku ini kalian akan berkenalan dengan salah satu karakter paling kuat di dunia paralel sejauh ini. Tapi itu jika kalian bisa menebaknya. Dua buku ini bukan akhir. Justru awal terbukanya kembali portal menuju Klan Aldebaran.",
        cover: {
            small: "../../assets/Selena.jpg",
            large: "../../assets/Selena.jpg"
        },
        contents: [
            {
                title: "Review",
    ...
    ,
    {
        title: "Pergi (Si Babi Hutan #2)",
        author: "Tere Liye",
        year: "2018",
        color: "#779fd1",
        categories: [
            "fiction", "indonesia", "action", "romance", "fantasy", "thriller", "family", "adventure"
        ],
        preview: "Sebuah kisah tentang menemukan tujuan, ke mana hendak pergi, melalui kenangan demi kenangan masa lalu, pertarungan hidup-mati, untuk memutuskan ke mana langkah kaki akan dibawa.",
        synopsis: "Sebuah kisah tentang menemukan tujuan, ke mana hendak pergi, melalui kenangan demi kenangan masa lalu, pertarungan hidup-mati, untuk memutuskan ke mana langkah kaki akan dibawa.",
        cover: {
            small: "../../assets/Pergi.jpg",
            large: "../../assets/Pergi.jpg"
        },
        contents: [
            {
                title: "Review",
    ...
    ,
    {
        ...
        preview: "Aku tahu sekarang, lebih banyak luka di hati bapakku dibanding di tubuhnya. Juga mamakku, lebih banyak tangis di hati Mamak dibanding di matanya.",
        synopsis: "Aku tahu sekarang, lebih banyak luka di hati bapakku dibanding di tubuhnya. Juga mamakku, lebih banyak tangis di hati Mamak dibanding di matanya. Sebuah kisah tentang perjalanan pulang, melalui pertarungan demi pertarungan, untuk memeluk erat semua kebencian dan rasa sakit.",
        cover: {
            small: "../../assets/Pulang.jpg",
            large: "../../assets/Pulang.jpg"
        },
        contents: [
            {
                title: "Review",
    ...
    ,
    {
        ...
        color: "#F0EFF6",
        categories: [
            "fiction", "indonesia", "romance", "inspirational", "family", "historical"
        ],
        preview: "Apalah arti memiliki, ketika diri kami sendiri bukanlah milik kami? Apalah arti kehilangan, ketika kami sebenarnya menemukan banyak saat kehilangan, dan sebaliknya,",
        ...
        cover: {
            small: "../../assets/Rindu.jpg",
            large: "../../assets/Rindu.jpg"
        },
        contents: [
            {
                title: "Review",
    ...
    ,
    {
        ...
        color: "#6f1d13",
        categories: [
            "fiction", "indonesia", "fantasy", "adventure", "young", "sci-fi", "action", "children"
        ],
        preview: "Namanya Ali, 15 tahun, kelas X. Jika saja orangtuanya mengizinkan, seharusnya dia sudah duduk di tingkat akhir ilmu fisika program doktor di universitas ternama.",
        synopsis: "Namanya Ali, 15 tahun, kelas X. Jika saja orangtuanya mengizinkan, seharusnya dia sudah duduk di tingkat akhir ilmu fisika program doktor di universitas ternama. Ali tidak menyukai sekolahnya, guru-gurunya, teman-teman sekelasnya. Semua membosankan baginya. Tapi sejak dia mengetahui ada yang aneh pada diriku dan Seli, teman sekelasnya, hidupnya yang membosankan berubah seru. Aku bisa menghilang, dan Seli bisa mengeluarkan petir. Ali sendiri punya rahasia kecil. Dia bisa berubah menjadi beruang raksasa. Kami bertiga kemudian bertualang ke tempat-tempat menakjubkan. Namanya Ali. Dia tahu sejak dulu dunia ini tidak sesederhana yang dilihat orang. Dan di atas segalanya, dia akhirnya tahu persahabatan adalah hal yang paling utama.",
        cover: {
            small: "../../assets/Matahari.jpg",
            large: "../../assets/Matahari.jpg"
        },
        contents: [
            {
                title: "Review",
    ...
    ,
    {
        ...
        preview: "Kita hanya punya sepotong hati, bukan? Satu-satunya. Lantas bagaimana kalau hati itu terluka? Disakiti justeru oleh orang yang kita cintai?",
        synopsis: "Kita hanya punya sepotong hati, bukan? Satu-satunya. Lantas bagaimana kalau hati itu terluka? Disakiti justeru oleh orang yang kita cintai? Aduh, apakah kita bisa mengobatinya? Apakah luka itu bisa pulih, tanpa bekas? Atau jangan-jangan, kita harus menggantinya dengan sepotong hati yang baru. Semoga datanglah pemahaman baik itu. Bahwa semua pengalaman cinta dan perasaan adalah spesial. Sama spesialnya dengan milik kita, tidak peduli sesederhana apapun itu, sepanjang dibungkus dengan pemahaman-pemahaman baik. Selamat membaca cerita-cerita Sepotong Hati Yang Baru.",
        cover: {
            small: "../../assets/Sepotong Hati Yang Baru.jpg",
            large: "../../assets/Sepotong Hati Yang Baru.jpg"
        },
        contents: [
            {
                title: "Review",
    ...
    ,
    {
        title: "Bintang (Bumi #4)",
        author: "Tere Liye",
        year: "2017",
        color: "#662671",
        categories: [
            "fiction", "indonesia", "fantasy", "adventure", "young", "sci-fi", "action", "children", "mystery"
        ],
        preview: "Kami bertiga teman baik. Remaja, murid kelas sebelas. Penampilan kami sama seperti murid SMA lainnya. Tapi kami menyimpan rahasia besar.",
        ...
        cover: {
            small: "../../assets/Bintang.jpg",
            large: "../../assets/Bintang.jpg"
        },
        contents: [
            {
                title: "Review",
    ...
    ,
    {
        ...
        color: "#bd8019",
        categories: [
            "fiction", "indonesia", "romance", "young", "family"
        ],
        preview: "Dia bagai malaikat bagi keluarga kami. Merengkuh aku, adikku, dan Ibu dari kehidupan jalanan yang miskin dan nestapa.",
        ...
        cover: {
            small: "../../assets/Daun Yang Jatuh Tak Pernah Membenci Angin.jpg",
            large: "../../assets/Daun Yang Jatuh Tak Pernah Membenci Angin.jpg"
        },
        contents: [
            {
                title: "Review",
